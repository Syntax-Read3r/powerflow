...
$_pf_components = @(
    ...
    "components\proxmox\host.ps1"
    "components\proxmox\physical-disks.ps1"
    "components\proxmox\evidence.ps1"
    "components\proxmox\disk-model.ps1"
    "components\proxmox\vm-read.ps1"
    "components\proxmox\network-config-model.ps1"
    "components\proxmox\guest-network-model.ps1"
    "components\proxmox\network-view.ps1"
    "components\proxmox\network-read.ps1"
    "components\proxmox\clone-plan.ps1"
    "components\proxmox\vm-change.ps1"
    "components\proxmox\disk-grow.ps1"
    "components\proxmox\snapshots.ps1"
    "components\proxmox\help.ps1"
    "components\proxmox\command.ps1"
